...
urlpatterns = [
    ...
    url(r'^fest_posking/$', ShowVideos.as_view(npk = 6, cpk = 22), name='posking'),
    url(r'^fest_show/$', ShowVideos.as_view(npk = 6, cpk = 23), name='fest_show'),
    url(r'^poka_live/$', ShowVideos.as_view(npk = 6, cpk = 24), name='poka_live'),
    url(r'^poka_highlight/$', ShowVideos.as_view(npk = 6, cpk = 25), name='poka_highlight'),
    ...
    url(r'^notice/$', Notices.as_view(), name='notice'),
